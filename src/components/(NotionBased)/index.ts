...
export type { NotionTableData } from "./components/NotionTable";

export { NotionTextColor, NotionBackgroundColor } from "./core/NotionBasedCore";
export type { NotionPropsColor, NotionPropsText } from "./core/NotionBasedCore";
