...
import { MasteryData, MasteryType } from "@/libs/stp@types";
...
export default function PageContent({ masteries }: PageContentProps) {
	...
	return (
		<>
			...
			{allProficiencyMasteries.length > 0 && (
				<>
					<UIBasics.Box
					...
					{allExpertiseMasteries.length > 0 && <UIBasics.Divisor />}
				</>
			)}
			{allExpertiseMasteries.length > 0 && (
				<>
					<UIBasics.Box
						backgroundColor="gray"
						withoutPadding>
					...
					{allKnowledgeMasteries.length > 0 && <UIBasics.Divisor />}
				</>
			)}
			{allKnowledgeMasteries.length > 0 && (
				<>
					<UIBasics.Box
						backgroundColor="gray"
						withoutPadding>
					...
					{allCraftMasteries.length > 0 && <UIBasics.Divisor />}
				</>
			)}
			{allCraftMasteries.length > 0 && (
				<>
					<UIBasics.Box
						backgroundColor="gray"
						withoutPadding>
