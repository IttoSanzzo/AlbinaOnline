...
const schema = z.object({
	...
	type: z
		.preprocess((type) => Number(type), z.nativeEnum(MasteryType))
		.refine((type) => type !== MasteryType.Unknown),
	subType: z
		.preprocess((subType) => Number(subType), z.nativeEnum(MasterySubType))
		.refine((subType) => subType !== MasterySubType.Unknown),
