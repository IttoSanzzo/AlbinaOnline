...
export const schema = z.object({
	...
	type: zEnumKey(CreatureType, ["Unknown"]),
	subType: zEnumKey(CreatureSubType, ["Unknown"]),
});
...
export function CreationForm({ form }: CreationFormProps) {
	void form;
	const typeOptions = enumToSelectOptions(CreatureType, ["Unknown"]);
	const subTypeOptions = enumToSelectOptions(CreatureSubType, ["Unknown"]);
