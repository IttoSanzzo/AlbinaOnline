...
export default async function IdaiteraDomainPage() {
	...
	return (
		<GenericPageContainer
			...
			icon={`${process.env.ALBINA_API}/favicon/spells/idaitera`}
			banner={`${process.env.ALBINA_API}/banner/spells/idaitera`}>
