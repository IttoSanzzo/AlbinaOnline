...
export default async function VerstandDomainPage() {
	...
	return (
		<GenericPageContainer
			title="Domínio Verstand"
			icon={`${process.env.ALBINA_API}/favicon/spells/verstand`}
			banner={`${process.env.ALBINA_API}/banner/spells/verstand`}>
